...
* Registration helps us understand who's interested in this event and join for a more interactive engagement during the sessions.Don't want to register, but want to join the sessions? Send us an email: hello at milli dot link. Just want to see the sessions? Head to the livestream (link shared above)
  ...
  **Discord Channel: [https://discord.gg/KzjDXC7VzF](https://discord.gg/KzjDXC7VzF)**
  ...
  Living document with schedule, session details, date and time, post event recordings (in a few weeks) at [http://j.mp/millisessions-iaw2021](https://j.mp/millisessions-iaw2021)
